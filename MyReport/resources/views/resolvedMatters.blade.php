...
<body class ="body-resolvedMatters">
    ...
    <section>
        ...
        <div class="overlay"></div>
            ...
            <div class="Titulo-Resolved-matters">
                <h> PROBLEMAS RESUELTOS</h>
            </div>
            <div class="subtitulo-Resolved-matters">
                <P>TRABAJAMOS POR UN DURANGO MEJOR</P>
            </div>
        </div>
    </section>
    ...
    <footer class="footer-terminos">
        ...
        <div class="titulos-footer">
            ...
            <div>
                <p>©2025 MyReport Todos los derechos reservados</p>
            </div>
        </div>
    </footer>
