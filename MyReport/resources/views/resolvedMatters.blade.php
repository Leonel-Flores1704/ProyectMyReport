...
<body class ="body-resolvedMatters">
    ...
    <div class = "titulos-resolved-matters">
        <h>BACHES</h>
    </div>
    <section>
        <div class="contenedor-cards">
            <div class="card-resovelM" style="width: 19rem;">
                <img src="{{ asset('/Imagenes/FondoRMDos.jpg') }}"  class="card-img-top" alt="...">
                <div class="cards-body-resolvedMatters">
                    <p class="card-text">ejempo del el texto que se scara de los repportes.</p>
                </div>
            </div>
    
            <div class="card-resovelM" style="width: 18rem;">
                <img src="{{ asset('/Imagenes/FondoRMDos.jpg') }}" class="card-img-top" alt="...">
                <div class="cards-body-resolvedMatters">
                    <p class="card-text">ejempo del el texto que se scara de los repportes</p>
                </div>
            ...
            <div class="card-resovelM" style="width: 18rem;">
                <img src="{{ asset('/Imagenes/FondoRMDos.jpg') }}" class="card-img-top" alt="...">
                <div class="cards-body-resolvedMatters">
                    <p class="card-text">ejempo del el texto que se scara de los repportes
                        calle benito 
                        colonia pedro.</p>
                </div>
            </div>
