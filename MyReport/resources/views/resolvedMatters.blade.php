...
<body class ="body-resolvedMatters">
    ...
    <div class="titulos-resolved-matters"><h>ALUMBRADO PÚBLICO</h></div>
    <section>
    ...
    <div class="centro-boton">
        <button id="ver-mas" class="boton-verMasRM">VER MÁS <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-down-circle" viewBox="0 0 16 16">
