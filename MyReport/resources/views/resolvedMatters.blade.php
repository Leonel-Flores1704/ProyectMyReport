...
<body class ="body-resolvedMatters">
    ...
    <section class="Fondo-RM d-flex align-items-center justify-content-center text-center">
    ...
    <div class="titulos-resolved-matters"><h>BACHES</h></div>
    <section>
        <div class="contenedor-cards contenedor-cards-B"></div>
            <div class="centro-boton">
            <button id="ver-mas-B" class="boton-verMasRM">
                VER MÁS
                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-arrow-down-circle icono-ver-mas" viewBox="0 0 16 16">
    ...
    <div class="titulos-resolved-matters"><h>SEMAFOROS NO FUNCIONALES</h></div>
    <section>
        <div class="contenedor-cards contenedor-cards-S"></div>
        <div class="centro-boton">
            <button id="ver-mas-S" class="boton-verMasRM">
                VER MÁS
                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-arrow-down-circle icono-ver-mas" viewBox="0 0 16 16">
                    <path fill-rule="evenodd" d="M1 8a7 7 0 1 0 14 0A7 7 0 0 0 1 8m15 0A8 8 0 1 1 0 8a8 8 0 0 1 16 0M8.5 4.5a.5.5 0 0 0-1 0v5.793L5.354 8.146a.5.5 0 1 0-.708.708l3 3a.5.5 0 0 0 .708 0l3-3a.5.5 0 0 0-.708-.708L8.5 10.293z"/>
                </svg>
    ...
    <div class="titulos-resolved-matters"><h>FOCOS DE INFECCIÓN</h></div>
    <section>
        <div class="contenedor-cards contenedor-cards-F"></div>
        <div class="centro-boton">
            <button id="ver-mas-F" class="boton-verMasRM">
                VER MÁS
                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-arrow-down-circle icono-ver-mas" viewBox="0 0 16 16">
                    <path fill-rule="evenodd" d="M1 8a7 7 0 1 0 14 0A7 7 0 0 0 1 8m15 0A8 8 0 1 1 0 8a8 8 0 0 1 16 0M8.5 4.5a.5.5 0 0 0-1 0v5.793L5.354 8.146a.5.5 0 1 0-.708.708l3 3a.5.5 0 0 0 .708 0l3-3a.5.5 0 0 0-.708-.708L8.5 10.293z"/>
                </svg>
    ...
    <div class="titulos-resolved-matters"><h>PLAZAS SUCIAS</h></div>
    <section>
        <div class="contenedor-cards contenedor-cards-P"></div>
        <div class="centro-boton">
            <button id="ver-mas-P" class="boton-verMasRM">
                VER MÁS
                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-arrow-down-circle icono-ver-mas" viewBox="0 0 16 16">
                    <path fill-rule="evenodd" d="M1 8a7 7 0 1 0 14 0A7 7 0 0 0 1 8m15 0A8 8 0 1 1 0 8a8 8 0 0 1 16 0M8.5 4.5a.5.5 0 0 0-1 0v5.793L5.354 8.146a.5.5 0 1 0-.708.708l3 3a.5.5 0 0 0 .708 0l3-3a.5.5 0 0 0-.708-.708L8.5 10.293z"/>
                </svg>
    ...
    <div class="titulos-resolved-matters"><h>TERRENOS BALDÍOS</h></div>
    <section>
        <div class="contenedor-cards contenedor-cards-T"></div>
        <div class="centro-boton">
            <button id="ver-mas-T" class="boton-verMasRM">
                VER MÁS
                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-arrow-down-circle icono-ver-mas" viewBox="0 0 16 16">
                    <path fill-rule="evenodd" d="M1 8a7 7 0 1 0 14 0A7 7 0 0 0 1 8m15 0A8 8 0 1 1 0 8a8 8 0 0 1 16 0M8.5 4.5a.5.5 0 0 0-1 0v5.793L5.354 8.146a.5.5 0 1 0-.708.708l3 3a.5.5 0 0 0 .708 0l3-3a.5.5 0 0 0-.708-.708L8.5 10.293z"/>
                </svg>
    ...
    <div class="titulos-resolved-matters"><h>ALUMBRADO PUBLICO</h></div>
    <section>
        <div class="contenedor-cards contenedor-cards-A"></div>
        <div class="centro-boton">
            <button id="ver-mas-A" class="boton-verMasRM">
                VER MÁS
                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-arrow-down-circle icono-ver-mas" viewBox="0 0 16 16">
                    <path fill-rule="evenodd" d="M1 8a7 7 0 1 0 14 0A7 7 0 0 0 1 8m15 0A8 8 0 1 1 0 8a8 8 0 0 1 16 0M8.5 4.5a.5.5 0 0 0-1 0v5.793L5.354 8.146a.5.5 0 1 0-.708.708l3 3a.5.5 0 0 0 .708 0l3-3a.5.5 0 0 0-.708-.708L8.5 10.293z"/>
                </svg>
    ...
    <script src="{{ asset('js/darklight.js') }}"></script>
